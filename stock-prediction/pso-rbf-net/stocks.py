...
__train_filepath = os.path.join(mainpath, 'Tesla_Stocks_Train.csv')
__test_filepath = os.path.join(mainpath, 'Tesla_Stocks_Test.csv')
...
def construct_time_frames(data, frame_size=64):
    ...
    x_train = data[: num_of_samples - frame_size]
    y_train = data[frame_size: num_of_samples, 0: 1]
